const QUOTES = [
  ...
  {
    id: 87,
    text: "Remove anything more interesting than getting rich and your brain will addict itself to this.",
    source: "Alex Becker",
  },
];
const titleEl = document.querySelector(".saved__title");
const sourceEl = document.querySelector(".saved__source")

const { text, source } = QUOTES[Math.floor(Math.random() * QUOTES.length)]
